...
public class RingtoneControl {
    ...
    public String getReaDefaultRingtone() {
        updateRingtone();
        //  File f = getAdsSummaryObjectRelevant();
//        if (f != null) {
//
//        }
//        // String str=RingtoneManager.getActualDefaultRingtoneUri(_context,RingtoneManager.TYPE_RINGTONE).toString();
//        // Toast.makeText(_context,"get ringtone "+str,Toast.LENGTH_LONG).show();
//
//
        return null;
    }
